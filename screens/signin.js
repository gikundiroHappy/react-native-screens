  ...
  return (
    <View>
     ...
     <View style={{paddingTop:10 , marginHorizontal:20}}>
        <TouchableOpacity style={{alignItems:"center",borderRadius:30, paddingVertical:20, backgroundColor:"black" }}><Text style={{color:"white", fontWeight:"bold"}}>Register</Text></TouchableOpacity>
      </View>
      <View style={{display:"flex", flexDirection:"row",justifyContent:"space-around",marginHorizontal:60, marginTop:40}}>
